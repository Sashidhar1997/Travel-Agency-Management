 ...
 * @author sashidhar
 */
public class StaffVacantVehicle extends javax.swing.JFrame {

    /**
     * Creates new form StaffVacantVehicle
     */
    public StaffVacantVehicle() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffVacantVehicle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffVacantVehicle().setVisible(true);
            }
        });
    }
